            ...
            <div class="h-vh-60 border-2 border-eternity-6-gray bg-eternity-6-black px-4 py-2">
                ...
                <div class="flex items-center gap-x-4 mb-4">
                    ...
                    <div class="cursor-pointer border border-white rounded-lg text-xl px-6 py-2 transition ease-in-out bg-transparent hover:bg-eternity-6-orange duration-300;"
                        onclick="openModal('guide');">Pricelist</div>
                </div>
                ...
                <div
                    ...
                    <div class="flex overflow-y-scroll h-vh-60">
                        <table class="font-montserrat w-full">
                            ...
                            <tr>
                                <td class="flex items-center gap-x-2"><img src="{{ asset('svg/flour.svg') }}" class="w-6 h-6 mr-2">Flour</td>
                                <td>-></td>
                                <td class="flex items-center gap-x-2"><img src="{{ asset('svg/oil.svg') }}" class="w-6 h-6 mr-2">Oil</td>
                                <td>10 Eternites</td>
                            </tr>
                            <tr>
                                <td class="flex items-center gap-x-2"><img src="{{ asset('svg/flour.svg') }}" class="w-6 h-6 mr-2">Flour</td>
                                <td>-></td>
                                <td class="flex items-center gap-x-2"><img src="{{ asset('svg/egg.svg') }}" class="w-6 h-6 mr-2">Egg</td>
                                <td>50 Eternites</td>
                            </tr>
                            <tr>
                                <td class="flex items-center gap-x-2"><img src="{{ asset('svg/flour.svg') }}" class="w-6 h-6 mr-2">Flour</td>
                                <td>-></td>
                                <td class="flex items-center gap-x-2"><img src="{{ asset('svg/meat.svg') }}" class="w-6 h-6 mr-2">Raw Meat</td>
                                <td>100 Eternites</td>
                            </tr>
                            <tr>
                                <td class="flex items-center gap-x-2"><img src="{{ asset('svg/oil.svg') }}" class="w-6 h-6 mr-2">Oil</td>
                ...
                <div
                    ...
                    <div class="flex overflow-y-scroll">
                        <table class="font-montserrat w-full">
                            ...
                            <tr>
                                <td class="flex items-center gap-x-2"><img src="{{ asset('svg/cloth.svg') }}" class="w-6 h-6 mr-2">Cloth</td>
                                <td>-></td>
                                <td class="flex items-center gap-x-2"><img src="{{ asset('svg/wood.svg') }}" class="w-6 h-6 mr-2">Wood</td>
                                <td>20 Eternites</td>
                            </tr>
                            <tr>
                                <td class="flex items-center gap-x-2"><img src="{{ asset('svg/cloth.svg') }}" class="w-6 h-6 mr-2">Cloth</td>
                                <td>-></td>
                                <td class="flex items-center gap-x-2"><img src="{{ asset('svg/iron.svg') }}" class="w-6 h-6 mr-2">Iron</td>
                                <td>50 Eternites</td>
                            </tr>
                            <tr>
                                <td class="flex items-center gap-x-2"><img src="{{ asset('svg/wood.svg') }}" class="w-6 h-6 mr-2">Wood</td>
