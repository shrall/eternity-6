...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->text('easy1')->default(0);
            $table->text('easy2')->default(0);
            $table->text('easy3')->default(0);
            $table->text('easy4')->default(0);
            $table->text('easy5')->default(0);
            $table->text('easy6')->default(0);
            $table->text('easy7')->default(0);
            $table->text('easy8')->default(0);
            $table->text('easy9')->default(0);
            $table->text('easy10')->default(0);
            ...
            $table->text('medium1')->default(0);
            $table->text('medium2')->default(0);
            $table->text('medium3')->default(0);
            $table->text('medium4')->default(0);
            $table->text('medium5')->default(0);
            $table->text('medium6')->default(0);
